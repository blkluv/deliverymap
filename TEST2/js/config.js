...
// Google Maps API 金鑰 (用於地理編碼)
export const GOOGLE_MAPS_API_KEY = "AIzaSyBa9P8XeaoUPUXPqMm8m6NHawZKFpCePqE";
// WebSocket 伺服器 URL
...
// --- 網格設定 ---
export const GRID_INTERVAL = 0.000033; // 網格大小 (經緯度)
export const GRID_PRECISION = 6;      // 座標儲存精度
export const GRID_DRAW_RADIUS = 5000; // 可繪製範圍半徑 (公尺)
export const GRID_ZOOM_LEVEL_WEB = 20;    // 桌面版進入網格模式的縮放層級
export const GRID_ZOOM_LEVEL_MOBILE = 19; // 行動版進入網格模式的縮放層級
